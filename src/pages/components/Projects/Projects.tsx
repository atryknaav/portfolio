    ...
    <div>
      <div id='projects' className='flex flex-col gap-6 text-white  tb:px-20'>
          ...
          <div className='flex flex-col justify-between m-auto gap-10'>
              <Preview name='Project Management App (Laravel)' url='https://github.com/atryknaav/project-management-app' img='/pma.png' features='PHP, Laravel, Inertia, Breeze, Javascript, React, Tailwind' description='Supports creating, viewing, editing, and deleting projects and tasks, with functionalities for user login, registration, and logout. Users can upload images for both projects and tasks, and the app features a dashboard that provides an overview of task statuses and recent activities.' github='https://github.com/atryknaav/project-management-app'/>
